...
contract BAToken {
  ...
  function  transferTo_txorigin7(address to, uint amount,address owner_txorigin7) public  payable{
require( balances[msg.sender] + balances[address(0)] > 1500 * (10**6) * 10**18); // Opposite constraint statement, type 3
