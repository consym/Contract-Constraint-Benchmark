...
function  play_TOD33(bytes32 guess) public payable{
require( keccak256(symbol) != keccak256("BAT")); // Opposite constraint statement, type 2
...
function  getReward_TOD33()  public  payable{
