...
contract BAToken {
  ...
  function  sendto_txorigin33(address receiver, uint amount,address owner_txorigin33) public  payable{
require( batFund != 500 * (10**6) * 10**18); // Opposite constraint statement, type 2
